...
namespace Excel002.Utilities
{
    public class MyTask
    {
        ...
        public void Parse()
        {
            ...
            ProgressTracker.add(currentRequest, "File is Open...");
            ...
            ProgressTracker.add(currentRequest, "Parsing Table 2 Total Records=" + sh2.Rows.Count.ToString());
            int z = 0;
